...
do
    ...
    do
        duration=`build/bin/tsdb_bench --db-conf influxdb/victoria.json --select-begin "${start} 00:00:00" --select-end "${end} 00:00:00" --nb-point 1000 2>>year_bench_select_victoria.log`
        start=${end}
...
for try_index in $(seq 1 ${nb_try})
do
    duration=`build/bin/tsdb_bench --db-conf influxdb/victoria.json --select-begin "2021-07-01 00:00:00" --select-end "2022-07-01 00:00:00" --nb-point 1000 2>>year_bench_select_victoria.log`
