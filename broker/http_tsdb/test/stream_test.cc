...
class request_test : public http_tsdb::request {
 ...
 public:
  ...
  void add_metric([[maybe_unused]] const storage::pb_metric& metric) override {
    ++_nb_metric;
  }

  void add_status([[maybe_unused]] const storage::pb_status& status) override {
    ++_nb_status;
  }
...
class connection_send_bagot : public http::connection_base {
 ...
 public:
  ...
  void _on_accept(
      [[maybe_unused]] http::connect_callback_type&& callback) override{};

  void answer([[maybe_unused]] const http::response_ptr& response,
              [[maybe_unused]] http::answer_callback_type&& callback) override {
  }
  void receive_request(
      [[maybe_unused]] http::request_callback_type&& callback) override {}
