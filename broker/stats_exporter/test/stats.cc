...
#include "com/centreon/broker/stats_exporter/worker.hh"
...
#include "com/centreon/broker/stats_exporter/builder.hh"
...
TEST_F(StatsExporterTest, Builder) {
  stats::builder build;
...
// TEST_F(StatsExporterTest, BuilderWithModules) {
//   stats::builder build;
...
TEST_F(StatsExporterTest, BuilderWithEndpoints) {
  stats::builder build;
  // File name.
...
TEST_F(StatsExporterTest, CopyCtor) {
  stats::builder build;
...
TEST_F(StatsExporterTest, Parser) {
  stats::parser parser;
...
TEST_F(StatsExporterTest, Worker) {
...
TEST_F(StatsExporterTest, WorkerPoolBadFile) {
  stats::worker_pool work;

  ASSERT_THROW(work.add_worker("/unexistingdir/file"), msg_fmt);
}

TEST_F(StatsExporterTest, WorkerPoolExistingDir) {
  stats::worker_pool work;

  ASSERT_THROW(work.add_worker("/tmp"), msg_fmt);
}

TEST_F(StatsExporterTest, WorkerPool) {
