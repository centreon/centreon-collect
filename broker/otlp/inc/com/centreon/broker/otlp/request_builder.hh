 ...
 * metrics on host.name. The service is carried as datapoint attributes rather
 * than a resource attribute so that grouping holds.
 */
class request_builder {
  ...
  ScopeMetrics* _scope_for_host(uint64_t host_id, const std::string& host_name);
