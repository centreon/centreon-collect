...
TEST(InfluxDBFactory, StatusException) {
  ...
  ASSERT_NO_THROW(ep.reset(fact.new_endpoint(cfg, {}, is_acceptor)));

  json js1 = json::object({{"name", json{nullptr}},
                           {"value", json{nullptr}},
                           {"is_tag", json{nullptr}},
                           {"type", json{nullptr}}});
  ...
  json js2 = json::object({{"name", "host"},
                           {"value", json{nullptr}},
                           {"is_tag", json{nullptr}},
                           {"type", json{nullptr}}});
  ...
  json js3 = json::object({{"name", "host"},
                           {"value", "val"},
                           {"is_tag", json{nullptr}},
                           {"type", json{nullptr}}});
  ...
  json js4 = json::object({{"name", "host"},
                           {"value", "val"},
                           {"is_tag", "true"},
                           {"type", json{nullptr}}});
  ...
  json js5 = json::object({{"name", "host"},
                           {"value", "val"},
                           {"is_tag", "true"},
                           {"type", "bad"}});
  ...
  json js6 = json::object({{"name", "host"},
                           {"value", "val"},
                           {"is_tag", "true"},
                           {"type", "number"}});
  conf["status_column"] = js6;
  cfg.cfg = conf;
  ASSERT_NO_THROW(delete fact.new_endpoint(cfg, {}, is_acceptor));

  json js7 = json::object(
      {{"name", ""}, {"value", "val"}, {"is_tag", "true"}, {"type", "number"}});
