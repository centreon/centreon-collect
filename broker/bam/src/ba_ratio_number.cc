...
ba_ratio_number::ba_ratio_number(uint32_t id,
    ...
    : ba(id, host_id, service_id, configuration::ba::state_source_ratio_number, generate_virtual_status)
      {}
 ...
 */
state ba_ratio_number::get_state_hard() {
  bam::state state;
 ...
 */
state ba_ratio_number::get_state_soft() {
  bam::state state;
