...
# 128 is reserved for this protobuf message
file_message_centreon_event += "        opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceRequest ExportMetricsServiceRequest_ = 128;\n"
