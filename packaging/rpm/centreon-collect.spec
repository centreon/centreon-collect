...
touch $RPM_BUILD_ROOT%{_localstatedir}/log/centreon-engine/centengine.log
touch $RPM_BUILD_ROOT%{_localstatedir}/log/centreon-engine/retention.dat
touch $RPM_BUILD_ROOT%{_localstatedir}/log/centreon-engine/status.dat
...
%changelog
* Thu Nov 3 2022 jcr <jcroques@centreon.com> 21.10.3
- import spec file from 22.04.
