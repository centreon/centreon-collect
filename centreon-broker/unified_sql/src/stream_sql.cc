    ...
    if (!_host_status_update.prepared()) {
      ...
      _host_status_update = qp.prepare_update_table(
          _mysql, "hosts",
          {
              ...
              {4, "active_checks", 0, 0},
              {5, "scheduled_downtime_depth", 0, 0},
              {6, "check_command", 0, get_hosts_col_size(hosts_check_command)},
              {7, "check_interval", 0, 0},
              {8, "check_period", 0, get_hosts_col_size(hosts_check_period)},
              {9, "check_type", 0, 0},
              {10, "check_attempt", 0, 0},
              {11, "state", 0, 0},
              {12, "event_handler_enabled", 0, 0},
              {13, "event_handler", 0, get_hosts_col_size(hosts_event_handler)},
              {14, "execution_time", 0, 0},
              {15, "flap_detection", 0, 0},
              {16, "checked", 0, 0},
              {17, "flapping", 0, 0},
              {18, "last_check", io::protobuf_base::invalid_on_zero, 0},
              {19, "last_hard_state", 0, 0},
              {20, "last_hard_state_change", io::protobuf_base::invalid_on_zero,
               0},
              {21, "last_notification", io::protobuf_base::invalid_on_zero, 0},
              {22, "notification_number", 0, 0},
              {23, "last_state_change", io::protobuf_base::invalid_on_zero, 0},
              {24, "last_time_down", io::protobuf_base::invalid_on_zero, 0},
              {25, "last_time_unreachable", io::protobuf_base::invalid_on_zero,
               0},
              {26, "last_time_up", io::protobuf_base::invalid_on_zero, 0},
              {27, "last_update", io::protobuf_base::invalid_on_zero, 0},
              {28, "latency", 0, 0},
              {29, "max_check_attempts", 0, 0},
              {30, "next_check", io::protobuf_base::invalid_on_zero, 0},
              {31, "next_host_notification", io::protobuf_base::invalid_on_zero,
               0},
              {32, "no_more_notifications", 0, 0},
              {33, "notify", 0, 0},
              {34, "output", 0, get_hosts_col_size(hosts_output)},
              {35, "passive_checks", 0, 0},
              {36, "percent_state_change", 0, 0},
              {37, "perfdata", 0, get_hosts_col_size(hosts_perfdata)},
              {38, "retry_interval", 0, 0},
              {39, "should_be_scheduled", 0, 0},
              {40, "obsess_over_host", 0, 0},
              {41, "state_type", 0, 0},
          });
    }
    ...
    if (!_service_status_update.prepared()) {
      ...
      _service_status_update = qp.prepare_update_table(
          _mysql, "services",
          {
              ...
              {30, "latency", 0, 0},
              {31, "max_check_attempts", 0, 0},
              {32, "next_check", io::protobuf_base::invalid_on_zero, 0},
              {33, "next_notification", io::protobuf_base::invalid_on_zero, 0},
              {34, "no_more_notifications", 0, 0},
              {35, "notify", 0, 0},
              {36, "output", 0, get_services_col_size(services_output)},
              {38, "passive_checks", 0, 0},
              {39, "percent_state_change", 0, 0},
              {40, "perfdata", 0, get_services_col_size(services_perfdata)},
              {41, "retry_interval", 0, 0},
              {44, "should_be_scheduled", 0, 0},
              {45, "state_type", 0, 0},
          });
    }
