				...
				<xsl:element name="tr">
					...
					<xsl:element name="td">
						...
						<xsl:element name="input">
							...
							<xsl:attribute name="name">w_<xsl:value-of select="host_id" />_<xsl:value-of select="service_id" /></xsl:attribute>
							<xsl:attribute name="value"><xsl:value-of select="//root/info/default_warning" /></xsl:attribute>
					...
					<xsl:element name="td">
						...
						<xsl:element name="input">
							<xsl:attribute name="type">text</xsl:attribute>
							<xsl:attribute name="name">c_<xsl:value-of select="host_id" />_<xsl:value-of select="service_id" /></xsl:attribute>
							<xsl:attribute name="value"><xsl:value-of select="//root/info/default_critical" /></xsl:attribute>
							<xsl:attribute name="size">5</xsl:attribute>
						</xsl:element>
						%
					</xsl:element>
					<xsl:element name="td">
						...
						<xsl:element name="input">
							<xsl:attribute name="type">text</xsl:attribute>
							<xsl:attribute name="name">u_<xsl:value-of select="host_id" />_<xsl:value-of select="service_id" /></xsl:attribute>
							<xsl:attribute name="value"><xsl:value-of select="//root/info/default_unknown" /></xsl:attribute>
							<xsl:attribute name="size">5</xsl:attribute>
						</xsl:element>
						%			
					</xsl:element>
