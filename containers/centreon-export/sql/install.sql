CREATE TABLE IF NOT EXISTS `mod_export_pluginpack` (
  ...
  `plugin_monitoring_procedure` TEXT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


CREATE TABLE `mod_export_links` (
...
INSERT INTO `topology` (`topology_id` ,`topology_name` ,`topology_parent` ,`topology_page` ,`topology_order` ,`topology_group` ,`topology_url` ,`topology_url_opt` ,`topology_popup` ,`topology_modules` ,`topology_show` ,`topology_style_class` ,`topology_style_id` ,`topology_OnClick`) VALUES (NULL , 'Export', '611', NULL , NULL , '36', NULL , NULL , NULL , NULL , '1', NULL , NULL , NULL);
INSERT INTO `topology` (`topology_id` ,`topology_name` ,`topology_parent` ,`topology_page` ,`topology_order` ,`topology_group` ,`topology_url` ,`topology_url_opt` ,`topology_popup` ,`topology_modules` ,`topology_show` ,`topology_style_class` ,`topology_style_id` ,`topology_OnClick`) VALUES (NULL , 'Export', '6', '611', '10', '36', NULL, NULL , NULL , '1', '1', NULL , NULL , NULL);

INSERT INTO `topology` (`topology_id` ,`topology_name` ,`topology_parent` ,`topology_page` ,`topology_order` ,`topology_group` ,`topology_url` ,`topology_url_opt` ,`topology_popup` ,`topology_modules` ,`topology_show` ,`topology_style_class` ,`topology_style_id` ,`topology_OnClick`) VALUES (NULL , 'Export', '611', '61101', '5', '36', './modules/centreon-export/core/pluginPack.php', NULL , NULL , '1', '1', NULL , NULL , NULL);
...
CREATE TABLE IF NOT EXISTS `mod_export_description` (
  ...
  `description_locale` int(11) DEFAULT NULL,
   ...
   CONSTRAINT `mod_export_description_ibfk_2` FOREIGN KEY (`description_locale`) REFERENCES `locale` (`locale_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `mod_export_discovery_category` (
...
(1, 'Windows Servers', 'windows-servers', '1.0.0', 'stable', 9),
(2, 'Linux Servers', 'linux-servers', '1.0.0', 'stable', 9),
(3, 'Cisco Hardware', 'cisco-hardware', '1.0.0', 'stable', 8);
