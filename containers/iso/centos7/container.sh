...
wget http://srvi-repo.int.centreon.com/iso/CentOS-7-x86_64-Minimal-1804.iso
...
mount -t iso9660 -o loop CentOS-7-x86_64-Minimal-1804.iso mount/
...
if [ "$VERSION" = '3.4' ] ; then
  ...
  wget -P centreon-iso/Packages http://srvi-repo.int.centreon.com/yum/standard/18.10/el7/stable/noarch/RPMS/centreon-release-18.10-1.el7.centos.noarch.rpm
  yum -y --disablerepo=updates install --nogpgcheck centreon-iso/Packages/centreon-release-18.10-1.el7.centos.noarch.rpm
