...
# INSERT INTO `nagios_server` VALUES (12,'poller_pullwss','0',0,0,'127.0.0.7','1','0','systemctl start centengine','systemctl stop centengine','systemctl restart centengine','systemctl reload centengine','/usr/sbin/centengine','/usr/sbin/centenginestats','/var/log/centreon-engine/service-perfdata','systemctl reload cbd','/etc/centreon-broker','/usr/share/centreon/lib/centreon-broker','/usr/lib64/centreon-connector',22,'4','443','tokenForWSS', 'centreontrapd','/etc/snmp/centreon_traps/',NULL,NULL,NULL,NULL,'1','0',1);
