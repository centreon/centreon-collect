...
INSERT IGNORE INTO `nagios_server` (
  ...
  (
    ...
    '1', '0', 22, '4', 443, 42992345, 'centreontrapd', '/etc/snmp/centreon_traps/',
    NULL, NULL, '/var/log/centreon-broker/',
    NULL, '1', '0'
  ), (
    4, 'pullwsspoller_4', '0', 0, NULL, '127.0.0.1',
    '1', '0', 22, '4', 443, 44992764, 'centreontrapd', '/etc/snmp/centreon_traps/',
    NULL, NULL, '/var/log/centreon-broker/',
    NULL, '1', '0'
  );
...
INSERT IGNORE INTO `cfg_nagios` (
  ...
  VALUES
  (
    15, 'pullwsspoller', NULL, '/var/log/centreon-engine/centengine.log',
