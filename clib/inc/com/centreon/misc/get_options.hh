...
class get_options {
 ...
 private:
  static void _array_to_vector(int argc, char** argv,
                               std::vector<std::string>& args);
  static bool _split_long(std::string const& line, std::string& key,
                          std::string& value);
  static bool _split_short(std::string const& line, std::string& key,
                           std::string& value);
};
}  // namespace com::centreon::misc
