 ...
 *
 */
#include "common/configuration/{name}_helper.hh"
{complement}
...
def prepare_filehelper_hh(cap_name: str, name: str):
    ...
    if cap_name == "State":
        fh_header = "#include \"common/configuration/state.pb.h\""
    elif cap_name == "Serviceescalation":
        fh_header = """#include "common/configuration/state-generated.pb.h"
