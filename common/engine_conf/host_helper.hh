...
/**
 * @brief Helper for the Host message. The helper is instanciated
...
class host_helper : public message_helper {
 ...
 public:
  ...
  static void _expand_hosts(configuration::State& s,
                            configuration::error_cnt& err);
};
}  // namespace com::centreon::engine::configuration

#endif /* !CCE_CONFIGURATION_HOST */
