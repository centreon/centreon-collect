...
class dummy_connection : public connection_base {
 ...
 public:
  ...
  void connect(connect_callback_type&&) override {}

  void send(request_ptr, send_callback_type&&) override {}
...
class answer_no_keep_alive : public base_class {
 public:
  ...
  void add_keep_alive_to_server_response(const response_ptr&) const override {}
};
