...
cd resources
python3 -m grpc_tools.protoc -I../../common/engine_conf -I../../engine/enginerpc -I../../common/src --python_out=. --grpc_python_out=. engine.proto
python3 -m grpc_tools.protoc -I../../common/engine_conf -I../../bbdo -I../../broker/core/src -I../../common/src --python_out=. --grpc_python_out=. broker.proto
python3 -m grpc_tools.protoc -I../../common/src --python_out=. --grpc_python_out=. process_stat.proto
for file in `ls ../../bbdo/*.proto` ; do
    python3 -m grpc_tools.protoc -I../../common/engine_conf -I../../bbdo --python_out=. --grpc_python_out=. `basename $file`
done
python3 ../../broker/grpc/generate_proto.py -f grpc_stream.proto -c /tmp/not_used.cc -d ../../bbdo
python3 -m grpc_tools.protoc -I../../common/engine_conf -I. -I../../bbdo -I../../opentelemetry-proto --python_out=. --grpc_python_out=. grpc_stream.proto
...
python3 -m grpc_tools.protoc -I../../common/engine_conf --python_out=. state.proto
cd ..
