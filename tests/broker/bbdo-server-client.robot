...
BSCSSTG3
	...
	Ctn Broker Config Output Set	central	central-broker-master-output	certificate	${EtcRoot}/centreon-broker/server.crt
	Ctn Broker Config Output Set	central	central-broker-master-output	ca_certificate	${EtcRoot}/centreon-broker/client.crt
	Ctn Broker Config Input Set	rrd	rrd-broker-master-input	private_key	${EtcRoot}/centreon-broker/missing-client.key
	Ctn Broker Config Input Set	rrd	rrd-broker-master-input	certificate	${EtcRoot}/centreon-broker/client.crt
	${start}=	Get Current Date
	Ctn Start Broker
...
BSCSSGA1
	...
	Ctn Config Broker Bbdo Output	central	bbdo_client	5670  grpc	localhost
	Ctn Config Broker Bbdo Input	rrd	bbdo_server	5670  grpc
	Ctn Broker Config Input Set	rrd	rrd-broker-master-input	authorization	titus
	Ctn Broker Config Log	central	config	off
	Ctn Broker Config Log	central	core	off
	Ctn Broker Config Log	rrd	core	off
...
BSCSSGA2
	...
	Ctn Config Broker Bbdo Input	rrd	bbdo_server	5670  grpc
	Ctn Broker Config Input Set	rrd	rrd-broker-master-input	authorization	titus
	Ctn Broker Config Output Set	central	central-broker-master-output	authorization	titus
