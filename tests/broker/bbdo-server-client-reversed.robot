...
BSCSSRR1
    ...
    Ctn Config Broker Bbdo Input    central    bbdo_server    5669  tcp
    Ctn Config Broker Bbdo Output    central    bbdo_server    5670  tcp
    Ctn Broker Config Output Set    central    central-broker-master-output    retention    yes
    Ctn Config Broker Bbdo Input    rrd    bbdo_client    5670  tcp    localhost
    Ctn Broker Config Log    central    config    debug
...
BSCSSTRR1
    ...
    Ctn Config Broker Bbdo Output    central    bbdo_server    5670  tcp
    Ctn Config Broker Bbdo Input    rrd    bbdo_client    5670  tcp    localhost
    Ctn Broker Config Output Set    central    central-broker-master-output    encryption    yes
    Ctn Broker Config Output Set    central    central-broker-master-output    retention    yes
...
BSCSSTRR2
    ...
    Ctn Broker Config Log    central    core    off
    Ctn Broker Config Log    central    tls    debug
    Ctn Broker Config Output Set    central    central-broker-master-output    private_key    ${EtcRoot}/centreon-broker/server.key
    Ctn Broker Config Output Set    central    central-broker-master-output    certificate    ${EtcRoot}/centreon-broker/server.crt
    Ctn Broker Config Output Set    central    central-broker-master-output    ca_certificate    ${EtcRoot}/centreon-broker/client.crt
...
BSCSSTGRR2
    ...
    Ctn Broker Config Input Set    rrd    rrd-broker-master-input    private_key    ${EtcRoot}/centreon-broker/client.key
    Ctn Broker Config Input Set    rrd    rrd-broker-master-input    certificate    ${EtcRoot}/centreon-broker/client.crt
    Ctn Broker Config Input Set    rrd    rrd-broker-master-input    ca_certificate    ${EtcRoot}/centreon-broker/server.crt
    ${start}=    Ctn Get Round Current Date
    Ctn Start Broker
...
BSCSSCRR1
    ...
    Ctn Config Broker Bbdo Output    central    bbdo_server    5670  tcp
    Ctn Config Broker Bbdo Input    rrd    bbdo_client    5670  tcp    localhost
    Ctn Broker Config Output Set    central    central-broker-master-output    compression    yes
    Ctn Broker Config Output Set    central    central-broker-master-output    retention    yes
    Ctn Broker Config Log    central    config    off
...
BSCSSCRR2
    ...
    Ctn Config Broker Bbdo Output    central    bbdo_server    5670  tcp
    Ctn Config Broker Bbdo Input    rrd    bbdo_client    5670  tcp    localhost
    Ctn Broker Config Output Set    central    central-broker-master-output    compression    no
    Ctn Broker Config Output Set    central    central-broker-master-output    retention    yes
    Ctn Broker Config Log    central    config    off
    Ctn Broker Config Log    central    core    off
    Ctn Broker Config Log    rrd    core    trace
