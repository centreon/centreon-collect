...
void randomize_init() {
  ...
  e.register_event(
      ...
      neb::de_downtime,
      io::event_info(
          "downtime", &neb::downtime::operations, neb::downtime::entries));
  e.register_event(io::events::neb,
  ...
  e.register_event(
      ...
      neb::de_instance,
      io::event_info(
          "instance", &neb::instance::operations, neb::instance::entries));
  e.register_event(io::events::neb,
  ...
  e.register_event(
      ...
      neb::de_log_entry,
      io::event_info(
          "log_entry", &neb::log_entry::operations, neb::log_entry::entries));
  e.register_event(
      io::events::neb,
      neb::de_module,
  ...
  e.register_event(
      ...
      neb::de_service,
      io::event_info(
          "service", &neb::service::operations, neb::service::entries));
  e.register_event(io::events::neb,
