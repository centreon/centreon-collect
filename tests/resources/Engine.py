...
def add_otl_server_module(idx: int, otl_server_config_json_content: str):
    """!
...
def create_otl_metric(name:str, nb_datapoints:int, attrib:dict):
    """
...
def create_otl_scope_metrics(scope_attr: dict, metrics: list):
    """
...
def create_otl_resource_metrics(resource_attr: dict, scope_metrics: list):
    """
...
def send_otl_to_engine(port: int, resource_metrics: list):
    """
    send_otl_to_engine
