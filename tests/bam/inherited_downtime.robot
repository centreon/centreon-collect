...
BEBAMIDT1
    ...
    # Let's wait for the initial service states.
        ...
        Should Be True    ${result}    An Initial service state on service (50, 1000) should be raised before we can start external commands.
...
BEBAMIGNDT1
    ...
    # KPI set to ok
    Repeat Keyword    3 times    Ctn Process Service Check Result    host_16    service_313    0    output critical for 313
