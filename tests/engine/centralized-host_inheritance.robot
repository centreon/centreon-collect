*** Settings ***
Documentation       Centreon Engine verify hosts inheritance with centralized configuration.
...
*** Test Cases ***
CEHI0
    [Documentation]    Given a centralized Engine configuration with an empty host inheriting from a full template
...
CEHI1
    [Documentation]    Given a centralized Engine configuration with a full host inheriting from a full template
    ...    When Engine and Broker are started in newGeneration mode
...
CEHI3
    [Documentation]    Given a centralized Engine configuration with a fully configured host inheriting from a full template
    ...    When Broker notifies Engine of the new centralized configuration
