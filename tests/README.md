...
- [x] **AOUTLU1**: an anomaly detection with a perfdata upper than the upper limit make a critical state with bbdo 3
...
- [x] **EBMSSM**: 1000 services are configured with 100 metrics each. The rrd output is removed from the broker configuration. GetSqlManagerStats is called to measure writes into data_bin.
