...
BECT2
	...
	Ctn Create Key And Certificate	localhost	${EtcRoot}/centreon-broker/server.key	${EtcRoot}/centreon-broker/server.crt
	Ctn Create Key And Certificate	localhost	${EtcRoot}/centreon-broker/client.key	${EtcRoot}/centreon-broker/client.crt

	Ctn Broker Config Input Set	central	central-broker-master-input	private_key	${EtcRoot}/centreon-broker/client.key
	Ctn Broker Config Input Set	central	central-broker-master-input	public_cert	${EtcRoot}/centreon-broker/client.crt
	Ctn Broker Config Input Set	central	central-broker-master-input	ca_certificate	${EtcRoot}/centreon-broker/server.crt
	Ctn Broker Config Output Set	module0	central-module-master-output	private_key	${EtcRoot}/centreon-broker/server.key
	Ctn Broker Config Output Set	module0	central-module-master-output	public_cert	${EtcRoot}/centreon-broker/server.crt
	Ctn Broker Config Output Set	module0	central-module-master-output	ca_certificate	${EtcRoot}/centreon-broker/client.crt
...
BECT4
	...
	Ctn Create Key And Certificate	${hostname}	${EtcRoot}/centreon-broker/server.key	${EtcRoot}/centreon-broker/server.crt
	Ctn Create Key And Certificate	${hostname}	${EtcRoot}/centreon-broker/client.key	${EtcRoot}/centreon-broker/client.crt
