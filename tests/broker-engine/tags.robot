...
# 	Reload Engine
# 	Reload Broker
# 	${result}=	check tag With Timeout	tag21	3	30
# 	Should Be True	${result}	msg=tag21 should be of type 4
# 	${result}=	check tag With Timeout	tag2	0	30
# 	Should Be True	${result}	msg=tag2 should be of type 1

# 	Create Tags File	${10}
# 	Reload Engine
# 	Reload Broker
# 	${result}=	check tag With Timeout	tag10	1	30
...
BEUTAG4
	...
	Create Tags File	${20}
	Config Engine Add Cfg File	tags.cfg
	Add Tags To Services	group_tags	5,9	[1, 2, 3, 4]
	Add Tags To Services	category_tags	7,11	[1, 2, 3, 4]
	Config Broker	central
	Config Broker	rrd
	Config Broker	module
	Config Broker Sql Output	central	unified_sql
...
BEUTAG5
	...
	Create Tags File	${20}
	Config Engine Add Cfg File	tags.cfg
	Add Tags To Host	group_tags	2,6	[1, 2, 3, 4]
	Add Tags To Host	category_tags	4,8	[1, 2, 3, 4]
	Config Broker	central
	Config Broker	rrd
	Config Broker	module
	Config Broker Sql Output	central	unified_sql
	...
	Sleep	1s
	Start Broker
	${result}=	check host tags With Timeout	1	1	6	60
