...
EBDP2
	[Documentation]	Three new pollers are started, then they are killed. After a simple reload of broker, it is still possible to remove Poller2 if removed from the configuration.
	[Tags]	Broker	Engine	grpc
	Config Engine	${3}	${50}	${20}
	Config Broker	rrd
	Config Broker	central
