...
BEOTEL_CENTREON_AGENT_CHECK_NATIVE_SERVICE_AUTO
    ...
    Ctn Engine Config Add Command    ${0}    otel_check   {"check": "service", "args": { "start-auto": "true", "filter-name": "CentreonMonitoringAgent", "critical-total-running": 1}}    OTEL connector
    ...
    Ctn Engine Config Add Command    ${0}    otel_check2   {"check": "service", "args": { "start-auto": false, "filter-name": "CentreonMonitoringAgent", "critical-total-running": 1}}    OTEL connector
    ...
    Ctn Engine Config Add Command    ${0}    otel_check3   {"check": "service", "args": { "filter-name": "CentreonMonitoringAgent", "critical-total-running": 1}}    OTEL connector
    ...
    Ctn Engine Config Add Command    ${0}    otel_check3   {"check": "service", "args": { "start-auto":"", "filter-name": "CentreonMonitoringAgent", "critical-total-running": 1}}    OTEL connector
