...
*** Test Cases ***
BEEXTCMD1
	[Documentation]	using bbdo3.0 the script configures the engine and broker, starts them, executes external commands to change the normal service check interval, verifies the interval values in the database, and stops the engine and broker. The process is repeated for different use_grpc values.
	...
	END
BEEXTCMD2
	[Documentation]	using bbdo2.0 the script configures the engine and broker, starts them, executes external commands to change the normal service check interval, verifies the interval values in the database, and stops the engine and broker. The process is repeated for different use_grpc values.
	[Tags]	Broker	Engine	services	extcmd
	Config Engine	${1}	${50}	${20}
	Config Broker	rrd
	Config Broker	central
...
BEEXTCMD3
	[Documentation]	external using bbdo3.0 the script configures the engine and broker, starts them, executes external commands to change the normal host check interval, verifies the interval value in the database, and stops the engine and broker. The process is repeated for different use_grpc values.
...
BEEXTCMD4
	[Documentation]	using bbdo2.0 the script configures the engine and broker, starts them, executes external commands to change the normal host check interval, verifies the interval value in the database, and stops the engine and broker. The process is repeated for different use_grpc values.
	[Tags]	Broker	Engine	host	extcmd
	Config Engine	${1}	${50}	${20}
	Config Broker	rrd
	Config Broker	central
