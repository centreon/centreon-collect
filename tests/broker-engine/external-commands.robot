...
*** Test Cases ***
BEEXTCMD1
    [Documentation] with bbdo3.0, executes external commands to change the normal service check interval, verifies the interval values in the database. The process is executed with the legacy external commands and then with grpc.
...
BEEXTCMD2
    [Documentation]  using bbdo2.0 the script executes external commands to change the normal service check interval, verifies the interval values in the database.
    [Tags]    broker    engine    services    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD3
    [Documentation]  using bbdo3.0 the script executes external commands to change the normal host check interval, verifies the interval value in the database.
...
BEEXTCMD4
    [Documentation] using bbdo2.0 the script executes external commands to change the normal host check interval, verifies the interval value in the database.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD5
    [Documentation]  using bbdo3.0, executes external commands to change the retry service check interval, verifies the interval value in the database. The process is repeated with grpc and legacy external command.
    [Tags]    broker    engine    services    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD6
    [Documentation] on bbdo2.0, this code executes external commands to change the retry service check interval, verifies the interval value in the database.
    [Tags]    broker    engine    services    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD7
    [Documentation] on bbdo3.0, this code executes external commands to change the retry host check interval, verifies the interval value in the database.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD8
    [Documentation] on bbdo2.0, this code executes external commands to change the retry host check interval, verifies the interval value in the database.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD9
    [Documentation] on bbdo3.0, executes external commands to change the maximum service check attempts, verifies the interval value in the database for both services and resources.
    [Tags]    broker    engine    services    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD10
    [Documentation] on bbdo2.0, executes external commands to change the maximum service check attempts, verifies the interval value in the database for both services and resources.
    [Tags]    broker    engine    services    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD11
    [Documentation] on bbdo3.0, executing external commands to change the maximum host check attempts, verifies the maximum attempts value in the database for both hosts and resources.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD12
    [Documentation] on bbdo2.0, executing external commands to change the maximum host check attempts, verifies the maximum attempts value in the database for both hosts and resources.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD13
    [Documentation] on bbdo3.0, executing an external command to change the host check time period, verifies the timeperiod value in the database for the host.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD14
    [Documentation] on bbdo2.0, executing an external command to change the host check timeperiod, verifies the timeperiod value in the database for the host where the result should be 24x6.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD15
    [Documentation] on bbdo3.0, executes an external command to change the host notification time period, verifies that the timeperiod value in the database for the host is changed.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD17
    [Documentation] on bbdo3.0, configures the service check timeperiod for a specific service on a host using the external command CHANGE_SVC_CHECK_TIMEPERIOD.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD18
    [Documentation]  on bbdo2.0, configures the service check timeperiod for a specific service on a host using the external command CHANGE_SVC_CHECK_TIMEPERIOD.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
...
BEEXTCMD20
    [Documentation] on bbdo2.0, service notification time period is changed using the Change Svc Notification Timeperiod external command for a specific service, checking the database for the value, and the result should be equal to 24x7.
    [Tags]    broker    engine    host    extcmd
    Config Engine    ${1}    ${50}    ${20}
    Config Broker    rrd
    Config Broker    central
