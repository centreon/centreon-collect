...
BECSEV1
    ...
    ${content}    Create List    20 severities added/modified    execute statement 674b495: INSERT INTO severities
    ...
    ${content}    Create List    10 severities added/modified    execute statement 674b495: INSERT INTO severities
    ${result}    Ctn Find In Log With Timeout    ${centralLog}    ${start}    ${content}    30
    Should Be True    ${result}    20 severities should be added/modified
    ${result}    Ctn Severities Are Identical    ${1}    ${VarRoot}/lib/centreon/config/1/severities.cfg
    Should Be True    ${result}    Severities are not identical between database and configuration file for poller 1.
    ...
    ${content}    Create List    11 severities added/modified    execute statement 674b495: INSERT INTO severities
    ${result}    Ctn Find In Log With Timeout    ${centralLog}    ${start}    ${content}    30
