...
void broker_module_init(void const* arg) {
  (void)arg;
  if (!neb_instances++) {
    logging::info(logging::high) << "NEB: module for Centreon Broker "
    ...
    if (neb_category != io::events::neb) {
      ...
      throw exceptions::msg_fmt(
          "NEB: category '{}' is already registered whereas it should be "
    ...
    // Register events.
    {
      e.register_event(io::events::neb,
                       neb::de_acknowledgement,
                       io::event_info("acknowledgement",
