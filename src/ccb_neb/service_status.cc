...
service_status::service_status(uint32_t type)
    : host_service_status(type, false, 0, false, "", 0.0, "", 0, 0, 4,
                          0, "", false, 0.0, false, false, 0, false, 0, 4,
                          0, 0, 0, 0, 0.0, 0, 0, 0, false, 0, false, "", false,
                          0.0, "", 0.0, false, 0),
...
service_status::service_status(std::string host_name,
                               bool acknowledged,
                               ...
                               short state_type)
    : host_service_status(service_status::static_type(),
                          acknowledged,
...
mapping::entry const service_status::entries[] = {
    ...
    mapping::entry(&service_status::host_name, ""),
    ...
    mapping::entry(&service_status::service_description, ""),
