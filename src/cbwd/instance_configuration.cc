 ...
 */
bool instance_configuration::is_empty() const throw() { return _name.empty(); }
 ...
 */
bool instance_configuration::should_run() const throw() { return _run; }
 ...
 */
bool instance_configuration::should_reload() const throw() { return _reload; }
