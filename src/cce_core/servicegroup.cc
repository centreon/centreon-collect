...
uint64_t servicegroup::get_id() const { return _id; }

void servicegroup::set_id(uint64_t id) { _id = id; }

std::string const& servicegroup::get_group_name() const { return _group_name; }

void servicegroup::set_group_name(std::string const& group_name) {
  _group_name = group_name;
}

std::string const& servicegroup::get_alias() const { return _alias; }

void servicegroup::set_alias(std::string const& alias) { _alias = alias; }

std::string const& servicegroup::get_notes() const { return _notes; }

void servicegroup::set_notes(std::string const& notes) { _notes = notes; }

std::string const& servicegroup::get_notes_url() const { return _notes_url; }

void servicegroup::set_notes_url(std::string const& notes_url) {
  _notes_url = notes_url;
}

std::string const& servicegroup::get_action_url() const { return _action_url; }
