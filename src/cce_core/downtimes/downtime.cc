 ...
 */
downtime::type downtime::get_type() const { return _type; }
 ...
 */
std::string const& downtime::get_hostname() const { return _hostname; }
 ...
 */
std::string const& downtime::get_comment() const { return _comment; }
 ...
 */
std::string const& downtime::get_author() const { return _author; }
 ...
 */
uint64_t downtime::get_downtime_id() const { return _downtime_id; }
 ...
 * @return A 64bits integer.
 */
uint64_t downtime::get_triggered_by() const { return _triggered_by; }
 ...
 * @return boolean.
 */
bool downtime::is_fixed() const { return _fixed; }
 ...
 */
time_t downtime::get_entry_time() const { return _entry_time; }
 ...
 */
time_t downtime::get_start_time() const { return _start_time; }
 ...
 */
time_t downtime::get_end_time() const { return _end_time; }
 ...
 */
int32_t downtime::get_duration() const { return _duration; }

bool downtime::is_in_effect() const { return _in_effect; }

void downtime::_set_in_effect(bool in_effect) { _in_effect = in_effect; }

uint64_t downtime::_get_comment_id() const { return _comment_id; }

void downtime::start_flex_downtime() { _start_flex_downtime = true; }
