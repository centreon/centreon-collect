 ...
 */
state::state(state const& right) { operator=(right); }
 ...
 */
std::string const& state::admin_email() const noexcept { return _admin_email; }
 ...
 */
void state::admin_email(std::string const& value) { _admin_email = value; }
 ...
 */
std::string const& state::admin_pager() const noexcept { return _admin_pager; }
 ...
 */
void state::admin_pager(std::string const& value) { _admin_pager = value; }
 ...
 */
void state::cfg_main(std::string const& value) { _cfg_main = value; }
 ...
 */
std::string const& state::cfg_main() const noexcept { return _cfg_main; }
 ...
 */
void state::check_host_freshness(bool value) { _check_host_freshness = value; }
 ...
 */
void state::check_orphaned_hosts(bool value) { _check_orphaned_hosts = value; }
 ...
 */
set_command const& state::commands() const noexcept { return _commands; }
 ...
 *  @return All engine commands.
 */
set_command& state::commands() noexcept { return _commands; }
 ...
 *          otherwise.
 */
set_command::const_iterator state::commands_find(command::key_type const& k)
    const {
 ...
 */
void state::command_file(std::string const& value) { _command_file = value; }
 ...
 */
set_connector const& state::connectors() const noexcept { return _connectors; }
 ...
 *  @return All engine connectors.
 */
set_connector& state::connectors() noexcept { return _connectors; }
 ...
 */
set_contact const& state::contacts() const noexcept { return _contacts; }
 ...
 *  @return All engine contacts.
 */
set_contact& state::contacts() noexcept { return _contacts; }
 ...
 *          otherwise.
 */
set_contact::const_iterator state::contacts_find(contact::key_type const& k)
    const {
 ...
 */
set_contactgroup& state::contactgroups() noexcept { return _contactgroups; }
 ...
 */
state::date_type state::date_format() const noexcept { return _date_format; }
 ...
 */
void state::date_format(date_type value) { _date_format = value; }
 ...
 */
std::string const& state::debug_file() const noexcept { return _debug_file; }
 ...
 */
void state::debug_file(std::string const& value) { _debug_file = value; }
 ...
 */
unsigned long long state::debug_level() const noexcept { return _debug_level; }
 ...
 */
void state::enable_notifications(bool value) { _enable_notifications = value; }
 ...
 */
void state::execute_host_checks(bool value) { _execute_host_checks = value; }
 ...
 */
set_hostgroup const& state::hostgroups() const noexcept { return _hostgroups; }
 ...
 *  @return All engine hostgroups.
 */
set_hostgroup& state::hostgroups() noexcept { return _hostgroups; }
 ...
 */
set_host const& state::hosts() const noexcept { return _hosts; }
 ...
 *  @return All engine hosts.
 */
set_host& state::hosts() noexcept { return _hosts; }
 ...
 */
bool state::log_event_handlers() const noexcept { return _log_event_handlers; }
 ...
 */
void state::log_event_handlers(bool value) { _log_event_handlers = value; }
 ...
 */
std::string const& state::log_file() const noexcept { return _log_file; }
 ...
 */
void state::log_file(std::string const& value) { _log_file = value; }
 ...
 */
bool state::log_host_retries() const noexcept { return _log_host_retries; }
 ...
 */
void state::log_host_retries(bool value) { _log_host_retries = value; }
 ...
 */
bool state::log_notifications() const noexcept { return _log_notifications; }
 ...
 */
void state::log_notifications(bool value) { _log_notifications = value; }
 ...
 */
bool state::log_passive_checks() const noexcept { return _log_passive_checks; }
 ...
 */
void state::log_passive_checks(bool value) { _log_passive_checks = value; }
 ...
 */
bool state::log_pid() const noexcept { return _log_pid; }
 ...
 */
void state::log_pid(bool value) { _log_pid = value; }
 ...
 */
void state::log_service_retries(bool value) { _log_service_retries = value; }
 ...
 */
bool state::obsess_over_hosts() const noexcept { return _obsess_over_hosts; }
 ...
 */
void state::obsess_over_hosts(bool value) { _obsess_over_hosts = value; }
 ...
 */
void state::obsess_over_services(bool value) { _obsess_over_services = value; }
 ...
 */
void state::ochp_command(std::string const& value) { _ochp_command = value; }
 ...
 */
unsigned int state::ochp_timeout() const noexcept { return _ochp_timeout; }
 ...
 */
void state::ocsp_command(std::string const& value) { _ocsp_command = value; }
 ...
 */
unsigned int state::ocsp_timeout() const noexcept { return _ocsp_timeout; }
 ...
 */
int state::perfdata_timeout() const noexcept { return _perfdata_timeout; }
 ...
 */
void state::perfdata_timeout(int value) { _perfdata_timeout = value; }
 ...
 */
void state::poller_name(std::string const& value) { _poller_name = value; }
 ...
 */
void state::poller_id(uint32_t value) { _poller_id = value; }
 ...
 *  @return The poller_id value.
 */
uint16_t state::rpc_port() const noexcept { return _poller_id; }
 ...
 *  @param[in] value The new poller_id value.
 */
void state::rpc_port(uint16_t value) { _poller_id = value; }
 ...
 *  @return All engine servicegroups.
 */
set_servicegroup& state::servicegroups() noexcept { return _servicegroups; }
 ...
 */
set_service const& state::services() const noexcept { return _services; }
 ...
 *  @return All engine services.
 */
set_service& state::services() noexcept { return _services; }
 ...
 */
float state::sleep_time() const noexcept { return _sleep_time; }
 ...
 */
std::string const& state::status_file() const noexcept { return _status_file; }
 ...
 */
void state::status_file(std::string const& value) { _status_file = value; }
 ...
 *  @return All engine timeperiods.
 */
set_timeperiod& state::timeperiods() noexcept { return _timeperiods; }
 ...
 */
bool state::use_regexp_matches() const noexcept { return _use_regexp_matches; }
 ...
 */
void state::use_regexp_matches(bool value) { _use_regexp_matches = value; }
 ...
 */
bool state::use_setpgid() const noexcept { return _use_setpgid; }
 ...
 */
void state::use_setpgid(bool value) { _use_setpgid = value; }
 ...
 */
bool state::use_syslog() const noexcept { return _use_syslog; }
 ...
 */
void state::use_syslog(bool value) { _use_syslog = value; }
 ...
 */
void state::use_timezone(std::string const& value) { _use_timezone = value; }
 ...
 */
void state::enable_macros_filter(bool value) { _enable_macros_filter = value; }
