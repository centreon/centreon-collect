 ...
 */
std::string const& timeperiod::alias() const throw() { return _alias; }
 ...
 */
set_string const& timeperiod::exclude() const throw() { return *_exclude; }
