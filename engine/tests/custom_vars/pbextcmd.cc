...
TEST_F(PbCustomVar, UpdateHostCustomVar) {
  ...
  hst.set_host_id(1);
  hst_hlp.hook("_PACKETNUMBER", "42");
  hst_hlp.hook("_WARNING", "200,20%");
  hst_hlp.hook("_CRITICAL", "400,50%");
  hst_hlp.hook("check_command", "base_centreon_ping");
