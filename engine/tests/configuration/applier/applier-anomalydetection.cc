...
TEST_F(ApplierAnomalydetection, PbNewHostWithoutHostId) {
...
TEST_F(ApplierAnomalydetection, PbNewADFromConfig) {
  configuration::applier::host hst_aply;
  configuration::applier::anomalydetection ad_aply;
  configuration::Anomalydetection ad;
...
// Then the applier add_object throws an exception
TEST_F(ApplierAnomalydetection, PbNewADNoServiceId) {
  configuration::applier::host hst_aply;
  configuration::applier::anomalydetection ad_aply;
  configuration::Anomalydetection ad;
  configuration::anomalydetection_helper ad_hlp(&ad);
...
// Then the applier add_object throws an exception
TEST_F(ApplierAnomalydetection, PbNewADNoHostId) {
  configuration::applier::host hst_aply;
  configuration::applier::anomalydetection ad_aply;
  configuration::Anomalydetection ad;
  configuration::anomalydetection_helper ad_hlp(&ad);
...
// Then the applier add_object throws an exception
TEST_F(ApplierAnomalydetection, PbNewADBadHostId) {
  configuration::applier::host hst_aply;
  configuration::applier::anomalydetection ad_aply;
  configuration::Anomalydetection ad;
  configuration::anomalydetection_helper ad_hlp(&ad);
...
// Then the applier add_object throws an exception
TEST_F(ApplierAnomalydetection, PbNewADNoMetric) {
  configuration::applier::host hst_aply;
  configuration::applier::anomalydetection ad_aply;
  configuration::Anomalydetection ad;
  configuration::anomalydetection_helper ad_hlp(&ad);
...
// Given service configuration without metric_name
// Then the applier add_object throws an exception
TEST_F(ApplierAnomalydetection, PbNewADNoThresholds) {
  configuration::applier::host hst_aply;
  configuration::applier::anomalydetection ad_aply;
  configuration::Anomalydetection ad;
  configuration::anomalydetection_helper ad_hlp(&ad);
