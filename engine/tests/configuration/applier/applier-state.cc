...
TEST_F(ApplierState, extended_override_conf) {
  ...
  "rpc_port": 12345,
  "high_service_flap_threshold": 45.789,
  "event_handler_timeout":8945613,
  "debug_level": 40000000000
})");
  ...
  ASSERT_NEAR(config.high_service_flap_threshold(), 45.789, 0.001);
  ASSERT_EQ(config.event_handler_timeout(), 8945613);
  ASSERT_EQ(config.debug_level(), 40000000000);
}
