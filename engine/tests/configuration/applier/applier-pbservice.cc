...
TEST_F(ApplierService, PbStalkingOptionsWhenServiceIsModified) {
  ...
  ASSERT_FALSE(serv->get_stalk_on(common::notifications::ok));
  ASSERT_FALSE(serv->get_stalk_on(common::notifications::warning));
  ASSERT_FALSE(serv->get_stalk_on(common::notifications::critical));
  ASSERT_FALSE(serv->get_stalk_on(common::notifications::unknown));

  ASSERT_TRUE(serv->get_notify_on(common::notifications::ok));
  ASSERT_TRUE(serv->get_notify_on(common::notifications::warning));
  ASSERT_TRUE(serv->get_notify_on(common::notifications::critical));
  ASSERT_TRUE(serv->get_notify_on(common::notifications::unknown));
