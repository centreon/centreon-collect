...
TEST_F(ApplierService, PbStalkingOptionsWhenServiceIsModified) {
  ...
  ASSERT_FALSE(serv->get_stalk_on(engine::notifications::ok));
  ASSERT_FALSE(serv->get_stalk_on(engine::notifications::warning));
  ASSERT_FALSE(serv->get_stalk_on(engine::notifications::critical));
  ASSERT_FALSE(serv->get_stalk_on(engine::notifications::unknown));

  ASSERT_TRUE(serv->get_notify_on(engine::notifications::ok));
  ASSERT_TRUE(serv->get_notify_on(engine::notifications::warning));
  ASSERT_TRUE(serv->get_notify_on(engine::notifications::critical));
  ASSERT_TRUE(serv->get_notify_on(engine::notifications::unknown));
