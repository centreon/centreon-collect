...
class contact {
 public:
  ...
  bool notify_on(common::notifications::notifier_type type,
                 common::notifications::notification_flag notif) const;
  uint32_t notify_on(common::notifications::notifier_type type) const;
  void set_notify_on(common::notifications::notifier_type type, uint32_t notif);
  void add_notify_on(common::notifications::notifier_type type,
                     common::notifications::notification_flag notif);
  void remove_notify_on(common::notifications::notifier_type type,
                        common::notifications::notification_flag notif);
  uint32_t notify_on(common::notifications::notifier_type type,
                     common::notifications::notifier_type notif) const;
