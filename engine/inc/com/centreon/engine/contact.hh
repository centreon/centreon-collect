...
class contact {
 public:
  typedef bool (contact::*to_notify)(notifications::reason_type,
  ...
  bool notify_on(notifications::notifier_type type,
                 notifications::notification_flag notif) const;
  uint32_t notify_on(notifications::notifier_type type) const;
  void set_notify_on(notifications::notifier_type type, uint32_t notif);
  void add_notify_on(notifications::notifier_type type,
                     notifications::notification_flag notif);
  void remove_notify_on(notifications::notifier_type type,
                        notifications::notification_flag notif);
  uint32_t notify_on(notifications::notifier_type type,
                     notifications::notifier_type notif) const;
  ...
  bool should_be_notified(notifications::notification_category cat,
 ...
 private:
  ...
  bool _to_notify_normal(notifications::reason_type type,
                         notifier const& notif) const;
  bool _to_notify_recovery(notifications::reason_type type,
                           notifier const& notif) const;
  bool _to_notify_acknowledgement(notifications::reason_type type,
                                  notifier const& notif) const;
  bool _to_notify_flapping(notifications::reason_type type,
                           notifier const& notif) const;
  bool _to_notify_downtime(notifications::reason_type type,
                           notifier const& notif) const;
  bool _to_notify_custom(notifications::reason_type type,
                         notifier const& notif) const;
