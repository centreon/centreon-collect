...
class host : public object {
 public:
  ...
  bool operator==(host const& right) const noexcept;
  bool operator!=(host const& right) const noexcept;
  ...
  opt<time_t> const& last_time_down() const noexcept;
  opt<time_t> const& last_time_unreachable() const noexcept;
  opt<time_t> const& last_time_up() const noexcept;
  ...
  opt<bool> const& notified_on_down() const noexcept;
  opt<bool> const& notified_on_unreachable() const noexcept;
  opt<int> const& obsess_over_host() const noexcept;
