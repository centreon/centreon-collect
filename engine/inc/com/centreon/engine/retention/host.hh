...
class host : public object {
 public:
  ...
  std::optional<time_t> const& last_time_down() const noexcept;
  std::optional<time_t> const& last_time_unreachable() const noexcept;
  std::optional<time_t> const& last_time_up() const noexcept;
  ...
  std::optional<bool> const& notified_on_down() const noexcept;
  std::optional<bool> const& notified_on_unreachable() const noexcept;
  std::optional<int> const& obsess_over_host() const noexcept;
 ...
 private:
  ...
  std::optional<time_t> _last_time_down;
  std::optional<time_t> _last_time_unreachable;
  std::optional<time_t> _last_time_up;
  ...
  std::optional<bool> _notified_on_down;
  std::optional<bool> _notified_on_unreachable;
  std::optional<int> _obsess_over_host;
