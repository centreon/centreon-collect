...
class escalation {
 ...
 public:
  ...
  void add_escalate_on(common::notifications::notification_flag type);
  void remove_escalate_on(common::notifications::notification_flag type);
  uint32_t get_escalate_on() const;
  bool get_escalate_on(common::notifications::notification_flag type) const;
