 ...
 */
bool program::operator==(program const& right) const noexcept {
  return (
      object::operator==(right) &&
      _active_host_checks_enabled == right._active_host_checks_enabled &&
      _active_service_checks_enabled == right._active_service_checks_enabled &&
 ...
 */
std::optional<uint64_t> const& program::next_problem_id() const noexcept {
 ...
 */
bool program::_set_next_problem_id(uint64_t value) {
