...
void escalation::add_escalate_on(notification::notification_flag type) {
  _escalate_on |= type;
}

void escalation::remove_escalate_on(notification::notification_flag type) {
  _escalate_on &= ~type;
}
...
bool escalation::get_escalate_on(notification::notification_flag type) const {
