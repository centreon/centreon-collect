...
void contact::resolve(uint32_t& w, uint32_t& e) {
  ...
  if (notify_on(notifications::host_notification, notifications::up) &&
      !notify_on(notifications::host_notification, notifications::down) &&
      !notify_on(notifications::host_notification,
                 notifications::unreachable)) {
    config_logger->warn(
  ...
  if (notify_on(notifications::service_notification, notifications::ok) &&
      !notify_on(notifications::service_notification,
                 notifications::critical) &&
      !notify_on(notifications::service_notification, notifications::warning)) {
    config_logger->warn(
