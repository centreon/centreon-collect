...
void applier::anomalydetection::modify_object(
  ...
  s->set_notify_on(
      (new_obj.notification_options() & configuration::anomalydetection::unknown
           ? notifier::unknown
           : notifier::none) |
      (new_obj.notification_options() & configuration::anomalydetection::warning
           ? notifier::warning
           : notifier::none) |
      (new_obj.notification_options() &
               configuration::anomalydetection::critical
           ? notifier::critical
           : notifier::none) |
      (new_obj.notification_options() & configuration::anomalydetection::ok
           ? notifier::ok
           : notifier::none) |
      (new_obj.notification_options() &
               configuration::anomalydetection::flapping
  ...
  s->add_stalk_on(new_obj.stalking_options() &
                          configuration::anomalydetection::ok
                      ? notifier::ok
                      : notifier::none);
  s->add_stalk_on(new_obj.stalking_options() &
