...
tag::tag(const key_type& key)
    : object(object::tag), _key{key}, _type{tag::none} {}
...
tag::tag(const tag& other)
    : object(other), _key{other._key}, _type{other._type}, _name{other._name} {}
...
bool tag::operator==(const tag& other) const noexcept {
  return _key == other._key && _type == other._type && _name == other._name;
}
