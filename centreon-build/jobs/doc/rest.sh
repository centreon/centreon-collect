...
EOF
    ...
    $SSH_REPO aws s3 sync --acl public-read "/srv/sources/internal/docrest/docrest-$BUILD_NUMBER/html-$lang" "s3://centreon-documentation-prod/docs/$PROJECT/$lang/$DOCTAG"
  fi
done
