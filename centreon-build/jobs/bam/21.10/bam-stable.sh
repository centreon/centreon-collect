...
promote_testing_rpms_to_stable "bam" "21.10" "el7" "noarch" "bam" "$PROJECT-$VERSION-$RELEASE"
promote_testing_rpms_to_stable "bam" "21.10" "el8" "noarch" "bam" "$PROJECT-$VERSION-$RELEASE"
