...
put_internal_rpms "18.10" "$DISTRIB" "noarch" "lm" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BRANCH_NAME" '=' '18.10.x' ] ; then
  copy_internal_rpms_to_canary "standard" "18.10" "el7" "noarch" "lm" "$PROJECT-$VERSION-$RELEASE"
fi
