...
$SSH_REPO "cd /tmp && tar zxf /srv/sources/hub/testing/$PROJECT-$VERSION/$PROJECT-$VERSION.tar.gz && aws s3 cp '/tmp/$PROJECT/build' 's3://centreon-hub-ui/preprod' --recursive"
