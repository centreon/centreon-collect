...
# Launch debuild.
containerid=`docker create registry.centreon.com/mon-build-dependencies-19.10:debian10 sh -c "cd /usr/local/src/debuildir/centreon-${VERSION} && debuild -us -uc -i"`
...
put_internal_debs "19.10" "buster" debuildir/*.deb
