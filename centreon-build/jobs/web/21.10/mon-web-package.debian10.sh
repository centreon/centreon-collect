...
# Launch debuild.
containerid=`docker create registry.centreon.com/mon-build-dependencies-21.10:debian10 sh -c "cd /usr/local/src/debuildir/centreon-${VERSION} && debuild -us -uc -i"`
