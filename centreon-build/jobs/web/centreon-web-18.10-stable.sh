...
promote_testing_rpms_to_stable "standard" "18.10" "el7" "noarch" "web" "$PROJECT-$VERSION-$RELEASE"
...
$SSH_DOC "'source /srv/env/documentation/bin/activate ; /srv/prod/readthedocs.org/readthedocs/manage.py update_repos centreon -V 18.10 -p'"
$SSH_DOC "'source /srv/env/documentation/bin/activate ; /srv/prod/readthedocs.org/readthedocs/manage_fr.py update_repos centreon -V 18.10 -p'"
