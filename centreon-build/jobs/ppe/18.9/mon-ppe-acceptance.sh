...
WEB_IMAGE="$REGISTRY/mon-web-18.9:$DISTRIB"
...
sed 's#@WEB_IMAGE@#'$PPE_IMAGE'#g' < `dirname $0`/../../../containers/web/18.9/docker-compose.yml.in > "$PROJECT-$VERSION/docker-compose-ppe.yml"
sed 's#@WEB_IMAGE@#'$PPE1_IMAGE'#g' < `dirname $0`/../../../containers/web/18.9/docker-compose.yml.in > "$PROJECT-$VERSION/docker-compose-ppe1.yml"
