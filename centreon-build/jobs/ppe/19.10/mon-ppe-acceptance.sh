...
WEB_IMAGE="$REGISTRY/mon-web-19.10:$DISTRIB"
...
sed 's#@WEB_IMAGE@#'$PPE_IMAGE'#g' < `dirname $0`/../../../containers/web/19.10/docker-compose.yml.in > "$PROJECT-$VERSION/docker-compose-ppe.yml"
