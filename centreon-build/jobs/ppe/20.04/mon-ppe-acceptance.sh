...
WEB_IMAGE="$REGISTRY/mon-web-20.04:$DISTRIB"
...
sed 's#@WEB_IMAGE@#'$PPE_IMAGE'#g' < `dirname $0`/../../../containers/web/20.04/docker-compose.yml.in > "$PROJECT-$VERSION/docker-compose-ppe.yml"
