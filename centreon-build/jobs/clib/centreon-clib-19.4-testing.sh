...
BUILD_CENTOS7=registry.centreon.com/mon-build-dependencies-19.4:centos7
...
put_testing_source "standard" "clib" "$PROJECT-$VERSION-$RELEASE" "input/$PROJECT-$VERSION.tar.gz"
put_testing_rpms "standard" "19.4" "el7" "x86_64" "clib" "$PROJECT-$VERSION-$RELEASE" output-centos7/x86_64/*.rpm
