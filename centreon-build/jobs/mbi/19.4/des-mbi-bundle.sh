...
sed "s/@DISTRIB@/$DISTRIB/g" < mbi/19.4/server.Dockerfile.in > mbi/server.Dockerfile
sed "s/@DISTRIB@/$DISTRIB/g" < mbi/19.4/web.Dockerfile.in > mbi/web.Dockerfile
...
MBI_WEB_WIP_IMAGE="$REGISTRY/des-mbi-web-19.4-wip:$DISTRIB"
