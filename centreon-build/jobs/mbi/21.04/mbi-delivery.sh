...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "mbi" "21.04" "el7" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
  copy_internal_rpms_to_testing "mbi" "21.04" "el8" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "mbi" "21.04" "el7" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
  promote_canary_rpms_to_unstable "mbi" "21.04" "el8" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
fi
