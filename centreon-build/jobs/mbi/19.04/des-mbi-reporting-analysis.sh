...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  sed -i -e 's/centreon-mbi-reporting-server-19.04/centreon-mbi-reporting-19.04-release/g' sonar-project.properties
  sed -i -e 's/Centreon MBI Reporting Server 19.04/Centreon MBI Reporting Server 19.04 (release)/g' sonar-project.properties
fi
