...
promote_rpms_from_testing_to_stable "mbi" "20.10" "el7" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "mbi" "20.10" "el8" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
