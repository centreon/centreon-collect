...
put_internal_source "mbi-web" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-$VERSION-php72.tar.gz"
put_internal_source "mbi-web" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-git.tar.gz"
