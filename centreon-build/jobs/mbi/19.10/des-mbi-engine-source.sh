...
put_internal_source "mbi-engine" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-$VERSION.tar.gz"
put_internal_source "mbi-engine" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-git.tar.gz"
