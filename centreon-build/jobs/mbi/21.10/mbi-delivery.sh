...
then
  put_rpms "business" "$MAJOR" "el7" "canary" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE" $EL7RPMS
  put_rpms "business" "$MAJOR" "el8" "canary" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE" $EL8RPMS
fi