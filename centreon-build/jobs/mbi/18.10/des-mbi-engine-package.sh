...
put_internal_rpms "18.10" "$DISTRIB" "noarch" "mbi-engine" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
promote_canary_rpms_to_unstable "mbi" "18.10" "el7" "noarch" "mbi-engine" "$PROJECT-$VERSION-$RELEASE"
