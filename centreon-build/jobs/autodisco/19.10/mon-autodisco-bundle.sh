...
sed "s/@DISTRIB@/$DISTRIB/g" < autodisco/19.10/Dockerfile.in > autodisco/Dockerfile
sed "s#@PROJECT@#$PROJECT#g;s#@SUBDIR@#19.10/el7/noarch/autodisco/$PROJECT-$VERSION-$RELEASE#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo

# Build image.
REGISTRY="registry.centreon.com"
AUTODISCO_IMAGE="$REGISTRY/mon-autodisco-$VERSION-$RELEASE:$DISTRIB"
AUTODISCO_WIP_IMAGE="$REGISTRY/mon-autodisco-19.10-wip:$DISTRIB"
