...
put_internal_rpms "19.4" "$DISTRIB" "x86_64" "autodisco" "$PROJECT-$VERSION-$RELEASE" output/x86_64/*.rpm
if [ "$BRANCH_NAME" '=' 'master' ] ; then
  copy_internal_rpms_to_canary "standard" "19.4" "el7" "x86_64" "autodisco" "$PROJECT-$VERSION-$RELEASE"
fi
