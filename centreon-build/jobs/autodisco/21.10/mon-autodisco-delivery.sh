...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "standard" "21.10" "el7" "noarch" "autodisco" "$PROJECT-$VERSION-$RELEASE"
  copy_internal_rpms_to_testing "standard" "21.10" "el8" "noarch" "autodisco" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "standard" "21.10" "el7" "noarch" "autodisco" "$PROJECT-$VERSION-$RELEASE"
  promote_canary_rpms_to_unstable "standard" "21.10" "el8" "noarch" "autodisco" "$PROJECT-$VERSION-$RELEASE"
