...
promote_testing_rpms_to_stable "standard" "21.04" "el7" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
promote_testing_rpms_to_stable "standard" "21.04" "el8" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
