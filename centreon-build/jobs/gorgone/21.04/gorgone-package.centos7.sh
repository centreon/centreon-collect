...
# Publish RPMs.
put_internal_rpms "21.04" "el7" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_unstable "standard" "21.04" "el7" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
fi
