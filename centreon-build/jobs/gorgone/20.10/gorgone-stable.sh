...
# Project.
export PROJECT=centreon-gorgone
...
$SSH_REPO mv "/srv/sources/standard/testing/gorgone/$PROJECT-$VERSION-$RELEASE" "/srv/sources/standard/stable/"
...
promote_rpms_from_testing_to_stable "standard" "20.10" "el7" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "20.10" "el8" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
