...
promote_rpms_from_testing_to_stable "standard" "$MAJOR" "el7" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "$MAJOR" "el8" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
