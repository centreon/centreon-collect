...
promote_rpms_from_testing_to_stable "standard" "21.10" "el7" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "21.10" "el8" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
