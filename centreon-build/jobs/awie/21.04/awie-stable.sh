...
$SSH_REPO mv "/srv/sources/standard/testing/awie/$PROJECT-$VERSION-$RELEASE" "/srv/sources/standard/stable/"
...
promote_rpms_from_testing_to_stable "standard" "21.04" "el7" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "21.04" "el8" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
