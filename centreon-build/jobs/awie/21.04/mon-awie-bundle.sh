...
if [ "$DISTRIB" '=' 'centos7' ] ; then
  sed "s#@PROJECT@#$PROJECT#g;s#@SUBDIR@#21.04/el7/noarch/awie/$PROJECT-$VERSION-$RELEASE#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo
else
  sed "s#@PROJECT@#$PROJECT#g;s#@SUBDIR@#21.04/el8/noarch/awie/$PROJECT-$VERSION-$RELEASE#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo
fi
