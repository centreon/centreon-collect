...
$SSH_REPO mv "/srv/sources/standard/testing/noarch/awie/$PROJECT-$VERSION-$RELEASE" "/srv/sources/standard/stable/"
...
promote_testing_rpms_to_stable "standard" "18.10" "el7" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
