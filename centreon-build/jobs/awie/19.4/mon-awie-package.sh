...
put_internal_rpms "19.4" "$DISTRIB" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BRANCH_NAME" '=' 'master' ] ; then
  copy_internal_rpms_to_canary "standard" "19.4" "el7" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
fi
