...
promote_rpms_from_testing_to_stable "standard" "$MAJOR" "el7" "noarch" "dsm" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "$MAJOR" "el8" "noarch" "dsm" "$PROJECT-$VERSION-$RELEASE"
