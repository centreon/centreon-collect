...
cp `dirname $0`"/../../../packaging/dsm/$PROJECT-19.04.spectemplate" input/
...
put_internal_rpms "19.04" "$DISTRIB" "noarch" "dsm" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "standard" "19.04" "el7" "noarch" "dsm" "$PROJECT-$VERSION-$RELEASE"
fi
