...
docker build --no-cache -t ci.int.centreon.com:5000/mon-dependencies:centos6 -f centreon-build/containers/dependencies.centos6.Dockerfile centreon-build/containers
