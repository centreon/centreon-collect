...
docker build -t ci.int.centreon.com:5000/mon-unittest:centos7 -f centreon-build/containers/unittest/unittest.centos7.Dockerfile centreon-build/containers
