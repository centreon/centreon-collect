...
docker build -t ci.int.centreon.com:5000/mon-unittest:centos6 -f centreon-build/containers/unittest/unittest.centos6.Dockerfile centreon-build/containers
