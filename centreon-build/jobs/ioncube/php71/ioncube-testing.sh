...
scp -o StrictHostKeyChecking=no $FILES_CENTOS7 "ubuntu@srvi-repo.int.centreon.com:/srv/yum/standard/19.04/el7/testing/x86_64/RPMS"
$SSH_REPO createrepo /srv/yum/standard/19.04/el7/testing/x86_64
