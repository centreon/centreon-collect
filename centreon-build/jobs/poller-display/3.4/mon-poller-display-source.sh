...
put_internal_source "poller-display" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-$VERSION.tar.gz"
put_internal_source "poller-display" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-git.tar.gz"
