...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "standard" "19.04" "el7" "noarch" "open-tickets" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "standard" "19.04" "el7" "noarch" "open-tickets" "$PROJECT-$VERSION-$RELEASE"
fi
