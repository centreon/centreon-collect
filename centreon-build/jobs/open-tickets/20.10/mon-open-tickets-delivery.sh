...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "standard" "20.10" "el8" "noarch" "open-tickets" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "standard" "20.10" "el8" "noarch" "open-tickets" "$PROJECT-$VERSION-$RELEASE"
fi
