...
docker pull registry.centreon.com/mon-build-dependencies-20.10:centos7
docker pull registry.centreon.com/mon-build-dependencies-20.10:centos8
...
# Build RPMs.
docker-rpm-builder dir --sign-with `dirname $0`/../../ces.key registry.centreon.com/mon-build-dependencies-20.10:centos7 input output-centos7
docker-rpm-builder dir --sign-with `dirname $0`/../../ces.key registry.centreon.com/mon-build-dependencies-20.10:centos8 input output-centos8
...
put_testing_rpms "standard" "20.10" "el7" "noarch" "widget" "$PROJECT-$VERSION-$RELEASE" output-centos7/noarch/*.rpm
put_testing_rpms "standard" "20.10" "el8" "noarch" "widget" "$PROJECT-$VERSION-$RELEASE" output-centos8/noarch/*.rpm
