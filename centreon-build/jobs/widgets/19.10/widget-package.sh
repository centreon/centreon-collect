...
# Build RPMs.
docker-rpm-builder dir --sign-with `dirname $0`/../../ces.key registry.centreon.com/mon-build-dependencies-19.10:$DISTRIB input output

# Publish RPMs.
put_internal_rpms "19.10" "el7" "noarch" "widgets" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "standard" "19.10" "el7" "noarch" "widgets" "$PROJECT-$VERSION-$RELEASE"
fi
