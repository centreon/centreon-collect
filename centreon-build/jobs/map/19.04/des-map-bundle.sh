...
DEP_IMAGE="$REGISTRY/mon-dependencies-19.04:$DISTRIB"
BASE_IMAGE="$REGISTRY/mon-web-19.04:$DISTRIB"
SERVER_IMAGE="$REGISTRY/des-map-server-$VERSION-$RELEASE:$DISTRIB"
SERVER_WIP_IMAGE="$REGISTRY/des-map-server-19.04-wip:$DISTRIB"
WEB_IMAGE="$REGISTRY/des-map-web-$VERSION-$RELEASE:$DISTRIB"
WEB_WIP_IMAGE="$REGISTRY/des-map-web-19.04-wip:$DISTRIB"
...
sed "s#@PROJECT@#map-web#g;s#@SUBDIR@#19.04/el7/noarch/map-web/$PROJECT-web-$VERSIONWEB-$RELEASE#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo
sed "s#@PROJECT@#map-server#g;s#@SUBDIR@#19.04/el7/noarch/map-server/$PROJECT-server-$VERSIONSERVER-$RELEASE#g" < repo/centreon-internal.repo.in >> repo/centreon-internal.repo
