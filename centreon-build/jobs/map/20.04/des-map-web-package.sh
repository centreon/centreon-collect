...
put_internal_rpms "20.04" "$DISTRIB" "noarch" "map-web" "$PROJECT-web-$VERSIONWEB-$RELEASE" output/noarch/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "map" "20.04" "el7" "noarch" "map-web" "$PROJECT-web-$VERSIONWEB-$RELEASE"
fi
