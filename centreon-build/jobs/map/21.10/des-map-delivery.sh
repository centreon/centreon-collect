...
then
  ...
  put_rpms "business" "$MAJOR" "el7" "unstable" "noarch" "map-server-ng" "centreon-map-server-$VERSIONSERVER-$RELEASE" $NGEL7RPMS
  put_rpms "business" "$MAJOR" "el8" "unstable" "noarch" "map-server-ng" "centreon-map-server-$VERSIONSERVER-$RELEASE" $NGEL8RPMS
  put_rpms "business" "$MAJOR" "el7" "unstable" "noarch" "map-web" "centreon-map-web-$VERSIONWEB-$RELEASE" $WEBEL7RPMS
  put_rpms "business" "$MAJOR" "el8" "unstable" "noarch" "map-web" "centreon-map-web-$VERSIONWEB-$RELEASE" $WEBEL8RPMS
elif [ "$BUILD" '=' 'RELEASE' ]
then
  put_rpms "business" "$MAJOR" "el7" "testing" "noarch" "map-server" "centreon-map-server-$VERSIONSERVER-$RELEASE" $SERVEREL7RPMS
  put_rpms "business" "$MAJOR" "el8" "testing" "noarch" "map-server" "centreon-map-server-$VERSIONSERVER-$RELEASE" $SERVEREL8RPMS
  put_rpms "business" "$MAJOR" "el7" "testing" "noarch" "map-server-ng" "centreon-map-server-$VERSIONSERVER-$RELEASE" $NGEL7RPMS
