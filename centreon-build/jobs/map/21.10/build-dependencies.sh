...
cp map/21.10/build-dependencies.Dockerfile.in Dockerfile
sed -i -e "s#@BASE_IMAGE@#$BASE_IMAGE#g" Dockerfile

# Build image.
TARGET_IMAGE_CENTOS7="registry.centreon.com/map-build-dependencies-21.10:centos7"
TARGET_IMAGE_CENTOS8="registry.centreon.com/map-build-dependencies-21.10:centos8"
