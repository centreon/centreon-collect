...
scp -o StrictHostKeyChecking=no $FILE_CENTOS6 ubuntu@srvi-repo.int.centreon.com:/srv/yum/map/3.4/el6/$REPO/noarch/RPMS/
scp -o StrictHostKeyChecking=no $FILE_CENTOS7 ubuntu@srvi-repo.int.centreon.com:/srv/yum/map/3.4/el7/$REPO/noarch/RPMS/
