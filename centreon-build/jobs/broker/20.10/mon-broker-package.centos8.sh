...
# Publish RPMs.
put_internal_rpms "20.10" "el8" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE" output/x86_64/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "standard" "20.10" "el8" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE"
fi
