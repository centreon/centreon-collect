...
cp `dirname $0`/../../../packaging/broker/rpm/21.04/centreon-broker.spectemplate input/
...
# Publish RPMs.
put_internal_rpms "21.04" "el7" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE" output/x86_64/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "standard" "21.04" "el7" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE"
fi
