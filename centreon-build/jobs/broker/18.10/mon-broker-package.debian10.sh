...
# Launch debuild.
containerid=`docker create ci.int.centreon.com:5000/mon-build-dependencies-18.10:debian10 sh -c "cd /usr/local/src/debuildir/${PROJECT}-${VERSION} && debuild -us -uc -i"`
...
put_internal_debs "18.10" "buster" debuildir/*.deb
