...
cp `dirname $0`/../../../packaging/broker/rpm/19.10/centreon-broker.spectemplate input/
...
# Publish RPMs.
put_internal_rpms "19.10" "leap" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE" output/x86_64/*.rpm
