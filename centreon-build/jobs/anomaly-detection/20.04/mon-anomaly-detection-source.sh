...
put_internal_source "anomaly-detection" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-$VERSION.tar.gz"
put_internal_source "anomaly-detection" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-git.tar.gz"
