...
promote_testing_rpms_to_stable "standard" "20.10" "el7" "noarch" "anomaly-detection" "$PROJECT-$VERSION-$RELEASE"
promote_testing_rpms_to_stable "standard" "20.10" "el8" "noarch" "anomaly-detection" "$PROJECT-$VERSION-$RELEASE"
