...
promote_rpms_from_testing_to_stable "standard" "20.10" "el7" "noarch" "anomaly-detection" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "20.10" "el8" "noarch" "anomaly-detection" "$PROJECT-$VERSION-$RELEASE"
