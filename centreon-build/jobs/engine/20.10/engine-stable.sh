...
promote_testing_rpms_to_stable "standard" "20.10" "el7" "x86_64" "engine" "$PROJECT-$VERSION-$RELEASE"
promote_testing_rpms_to_stable "standard" "20.10" "el8" "x86_64" "engine" "$PROJECT-$VERSION-$RELEASE"
