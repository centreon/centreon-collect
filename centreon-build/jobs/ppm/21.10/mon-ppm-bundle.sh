...
PPM_WIP_IMAGE="$REGISTRY/mon-ppm-21.10-wip:$DISTRIB"
PPM_AUTODISCO_IMAGE="$REGISTRY/mon-ppm-autodisco-$VERSION-$RELEASE:$DISTRIB"
PPM_AUTODISCO_WIP_IMAGE="$REGISTRY/mon-ppm-autodisco-21.10-wip:$DISTRIB"
WEB_IMAGE="$REGISTRY/mon-web-21.10.0-beta.1-1632468206.159a78837e:$DISTRIB"
