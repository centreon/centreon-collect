...
# Project.
export PROJECT=centreon-pp-manager
...
$SSH_REPO mv "/srv/sources/standard/testing/ppm/$PROJECT-$VERSION-$RELEASE" "/srv/sources/standard/stable/"
...
promote_rpms_from_testing_to_stable "standard" "20.10" "el7" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "20.10" "el8" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE"
