...
# Put sources online.
upload_tarball_for_download centreon-connectors "$VERSION" "/srv/sources/standard/stable/$PROJECT-$VERSION-$RELEASE/$PROJECT-$VERSION.tar.gz" "s3://centreon-download/public/centreon-connectors/$PROJECT-$VERSION.tar.gz"

# Move RPMs to the stable repository.
promote_testing_rpms_to_stable "standard" "19.04" "el7" "x86_64" "connector" "$PROJECT-$VERSION-$RELEASE"
