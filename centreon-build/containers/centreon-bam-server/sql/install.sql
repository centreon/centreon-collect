...
('Business Activity',  '2', '207', '30', '1', './modules/centreon-bam-server/core/dashboard/dashboard.php', NULL, '0', '1', '1'),
('Views',  '207', NULL, NULL, '1', NULL, NULL, '0', '1', '1'),
('Monitoring', '207', '20701', '10', '1', './modules/centreon-bam-server/core/dashboard/dashboard.php', NULL, NULL, '1', '1'),
('Reporting', '207', '20702', '20', '1', './modules/centreon-bam-server/core/reporting/reporting.php', NULL, NULL, '1', '1'),
('Logs', '207', '20703', '30', '1', './modules/centreon-bam-server/core/logs/logs.php', NULL, NULL, '1', '1'),
('Business Activity', '6', '626', '20', '1', './modules/centreon-bam-server/core/configuration/group/configuration_ba_group.php', NULL, '0', '1', '1'),
('Management', '626', NULL, NULL, '1', NULL, NULL, '0', '1', '1'),
('Business Views', '626', '62604', '10', '1', './modules/centreon-bam-server/core/configuration/group/configuration_ba_group.php', NULL, NULL, '1', '1'),
('Business Activity', '626', '62605', '20', '1', './modules/centreon-bam-server/core/configuration/ba/configuration_ba.php', NULL, NULL, '1', '1'),
('Indicators', '626', '62606', '30', '1', './modules/centreon-bam-server/core/configuration/kpi/configuration_kpi.php', NULL, NULL, '1', '1'),
('Boolean Rules', '626', '62611', '40', '1', './modules/centreon-bam-server/core/configuration/boolean/configuration_boolean.php', NULL, NULL, '1', '1'),
...
('Options', '626', NULL, NULL, '2', NULL, NULL, '0', '1', '1'),
('Default Settings', '626', '62607', '10', '2', './modules/centreon-bam-server/core/options/general/general.php', NULL, NULL, '1', '1'),
('User Settings', '626', '62608', '10', '2', './modules/centreon-bam-server/core/options/user/user.php', NULL, NULL, '1', '1'),
('Help', '626', NULL, NULL, '3', NULL, NULL, '0', '1', '1'),
('Troubleshooter', '626', '62610', '10', '3', './modules/centreon-bam-server/core/help/troubleshooter/troubleshooter.php', NULL, NULL, '1', '1');
...
INSERT INTO `command` (`command_name`,`command_line`,`command_type`,`enable_shell`,`command_example`,`graph_id`) VALUES ('bam-notify-by-email', '/usr/bin/printf \"%b\" \"***** Centreon BAM *****\\n\\nNotification Type: \$NOTIFICATIONTYPE\$\\n\\nBusiness Activity: \$SERVICEDISPLAYNAME\$\\nState: \$SERVICESTATE\$\\n\\nDate: \$DATE\$ \$TIME\$\\n\\nAdditional Info:\\n\\n\$SERVICEOUTPUT\$\" | @MAILER@ -s \"** \$NOTIFICATIONTYPE\$ - \$SERVICEDISPLAYNAME\$ is \$SERVICESTATE\$ **\" \$CONTACTEMAIL\$',1,1,'',0);
