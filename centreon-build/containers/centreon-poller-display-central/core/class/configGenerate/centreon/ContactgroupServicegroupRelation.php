...
class ContactgroupServicegroupRelation extends Object
{
    /**
     * @var table
     */
    protected $table = 'contactgroup_servicegroup_relation';
    ...
    public function getList($clauseObject = null)
    {
        ...
        $first = true;
        $clauseQuery = ' WHERE servicegroup_sg_id IN (';
