...
promote_testing_rpms_to_stable "mbi" "19.10" "el7" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
...
$SSH_REPO aws s3 cp --acl public-read "/srv/sources/mbi/stable/$PROJECT-$VERSION-$RELEASE/centreon-bi-server-$VERSION-php72.tar.gz" "s3://centreon-download/enterprises/centreon-mbi/centreon-mbi-19.10/centreon-mbi-$VERSION/$SRCHASH/centreon-bi-server-$VERSION-php72.tar.gz"
