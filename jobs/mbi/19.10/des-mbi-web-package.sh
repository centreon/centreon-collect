...
put_internal_rpms "19.10" "$DISTRIB" "noarch" "mbi-web" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "mbi" "19.10" "el7" "noarch" "mbi-web" "$PROJECT-$VERSION-$RELEASE"
fi
