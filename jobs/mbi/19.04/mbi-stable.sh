...
promote_testing_rpms_to_stable "mbi" "19.04" "el7" "noarch" "mbi" "$PROJECT-$VERSION-$RELEASE"
...
$SSH_REPO aws s3 cp --acl public-read "/srv/sources/mbi/stable/$PROJECT-$VERSION-$RELEASE/$PROJECT-$VERSION-php72.tar.gz" "s3://centreon-download/enterprises/centreon-mbi/centreon-mbi-19.04/centreon-mbi-$VERSION/$SRCHASH/$PROJECT-$VERSION-php72.tar.gz"
