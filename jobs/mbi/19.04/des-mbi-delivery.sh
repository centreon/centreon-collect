...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "mbi" "19.04" "el7" "noarch" "mbi-web" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "mbi" "19.04" "el7" "noarch" "mbi-web" "$PROJECT-$VERSION-$RELEASE"
fi
