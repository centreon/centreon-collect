...
docker build -t ci.int.centreon.com:5000/mon-build-dependencies:centos6 -f centreon-build/containers/build-dependencies.centos6.Dockerfile centreon-build/containers
