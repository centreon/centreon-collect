...
docker build --no-cache -t ci.int.centreon.com:5000/mon-dependencies:centos7 -f centreon-build/containers/dependencies.centos7.Dockerfile centreon-build/containers
