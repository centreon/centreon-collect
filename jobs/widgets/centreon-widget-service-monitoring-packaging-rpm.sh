...
cd centreon-widget-service-monitoring
git checkout --detach "tags/$VERSION"
rm -rf "../centreon-widget-service-monitoring-$VERSION"
mkdir "../centreon-widget-service-monitoring-$VERSION"
git archive HEAD | tar -C "../centreon-widget-service-monitoring-$VERSION" -x
cd ..
tar czf "input/centreon-widget-service-monitoring-$VERSION.tar.gz" "centreon-widget-service-monitoring-$VERSION"
...
cp packaging-centreon-web/rpm/widgets/centreon-widget-service-monitoring.spectemplate input/
