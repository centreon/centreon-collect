...
docker pull registry.centreon.com/mon-build-dependencies-19.10:centos7
...
put_testing_rpms "standard" "19.10" "el7" "noarch" "widget" "$PROJECT-$VERSION-$RELEASE" output-centos7/noarch/*.rpm
