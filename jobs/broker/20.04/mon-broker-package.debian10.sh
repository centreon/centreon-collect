...
# Launch debuild.
containerid=`docker create registry.centreon.com/mon-build-dependencies-20.04:debian10 sh -c "cd /usr/local/src/debuildir/${PROJECT}-${VERSION} && export ARCH=x86_64 && debuild --preserve-envvar ARCH -us -uc -i"`
