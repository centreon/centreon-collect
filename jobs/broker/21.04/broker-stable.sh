...
promote_testing_rpms_to_stable "standard" "21.04" "el7" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE"
promote_testing_rpms_to_stable "standard" "21.04" "el8" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE"
