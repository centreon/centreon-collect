...
cp packaging-centreon-broker/rpm/centreon-broker-18.9.spectemplate input/
...
# Publish RPMs.
put_internal_rpms "18.9" "leap" "x86_64" "broker" "$PROJECT-$VERSION-$RELEASE" output/x86_64/*.rpm
