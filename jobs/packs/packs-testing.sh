...
promote_unstable_rpms_to_testing "plugin-packs" "21.10" "el7" "noarch" "packs" "$PROJECT-$VERSION-$RELEASE"
promote_unstable_rpms_to_testing "plugin-packs" "21.10" "el8" "noarch" "packs" "$PROJECT-$VERSION-$RELEASE"
