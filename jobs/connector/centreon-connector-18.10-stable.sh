...
curl "https://download.centreon.com/api/?token=ML2OA4P43FDF456FG3EREYUIBAHT521&product=centreon-connectors&version=$VERSION&extension=tar.gz&md5=$SRCHASH&ddos=0&dryrun=1"
