...
# Put sources online.
upload_artifact_for_download centreon-connectors 3.4 "$VERSION" tar.gz 0 "/srv/sources/standard/stable/$PROJECT-$VERSION-$RELEASE/$PROJECT-$VERSION.tar.gz" "s3://centreon-download/public/centreon-connectors/$PROJECT-$VERSION.tar.gz"
