...
# Launch debuild.
containerid=`docker create ci.int.centreon.com:5000/mon-build-dependencies-19.4:debian10 sh -c "cd /usr/local/src/debuildir/centreon-${VERSION} && debuild -us -uc -i"`
