...
# Publish RPMs.
put_internal_rpms "21.10" "el7" "noarch" "web" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "standard" "21.10" "el7" "noarch" "web" "$PROJECT-$VERSION-$RELEASE"
fi
