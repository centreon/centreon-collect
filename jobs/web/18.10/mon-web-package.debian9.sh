...
# Launch debuild.
containerid=`docker create ci.int.centreon.com:5000/mon-build-dependencies-18.10:debian9 sh -c "cd /usr/local/src/debuildir/centreon-${VERSION} && debuild -us -uc -i"`
