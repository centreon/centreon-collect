...
$SSH_REPO mv "/srv/sources/standard/testing/noarch/open-tickets/$PROJECT-$VERSION-$RELEASE" "/srv/sources/standard/stable/"
...
$SSH_DOC "'source /srv/env/documentation/bin/activate ; /srv/prod/readthedocs.org/readthedocs/manage.py update_repos centreon-open-tickets -V latest -p'"
$SSH_DOC "'source /srv/env/documentation/bin/activate ; /srv/prod/readthedocs.org/readthedocs/manage_fr.py update_repos centreon-open-tickets -V latest -p'"
