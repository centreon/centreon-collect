...
put_internal_source "open-tickets" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-$VERSION.tar.gz"
put_internal_source "open-tickets" "$PROJECT-$VERSION-$RELEASE" "$PROJECT-git.tar.gz"
