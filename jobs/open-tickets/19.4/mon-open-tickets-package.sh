...
cp `dirname $0`"/../../../packaging/open-tickets/$PROJECT-19.4.spectemplate" input/
...
put_internal_rpms "19.4" "$DISTRIB" "noarch" "open-tickets" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BRANCH_NAME" '=' 'master' ] ; then
  copy_internal_rpms_to_canary "standard" "19.4" "el7" "noarch" "open-tickets" "$PROJECT-$VERSION-$RELEASE"
fi
