...
# Publish RPMs.
put_internal_rpms "21.10" "el8" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_unstable "standard" "21.10" "el8" "noarch" "gorgone" "$PROJECT-$VERSION-$RELEASE"
fi
