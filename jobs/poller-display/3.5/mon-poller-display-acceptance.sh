...
sed -e 's#@WEB_IMAGE@#'$CENTRAL_IMAGE'#g' -e 's#@POLLER_IMAGE@#'$POLLER_IMAGE'#g' < `dirname $0`/../../../containers/poller-display/3.5/docker-compose.yml.in > mon-poller-display-dev.yml
