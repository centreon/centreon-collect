...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "standard" "20.04" "el7" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "standard" "20.04" "el7" "noarch" "awie" "$PROJECT-$VERSION-$RELEASE"
