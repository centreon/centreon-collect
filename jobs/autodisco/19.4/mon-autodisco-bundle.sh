...
sed "s/@DISTRIB@/$DISTRIB/g" < autodisco/19.4/Dockerfile.in > autodisco/Dockerfile
sed "s#@PROJECT@#$PROJECT#g;s#@SUBDIR@#19.4/el7/x86_64/autodisco/$PROJECT-$VERSION-$RELEASE#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo

# Build image.
REGISTRY="ci.int.centreon.com:5000"
AUTODISCO_IMAGE="$REGISTRY/mon-autodisco-$VERSION-$RELEASE:$DISTRIB"
AUTODISCO_WIP_IMAGE="$REGISTRY/mon-autodisco-19.4-wip:$DISTRIB"
