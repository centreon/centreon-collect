...
put_testing_source "standard" "lm" "$PROJECT-$VERSION-$RELEASE" "input/$PROJECT-$VERSION-php71.tar.gz"
put_testing_rpms "standard" "19.04" "el7" "noarch" "lm" "$PROJECT-$VERSION-$RELEASE" output-centos7/noarch/*.rpm
