...
sed "s/@DISTRIB@/$DISTRIB/g" < lm/19.10/lm.Dockerfile.in > lm/lm.$DISTRIB.Dockerfile
sed "s#@PROJECT@#$PROJECT#g;s#@SUBDIR@#19.10/el7/noarch/lm/$PROJECT-$VERSION-$RELEASE#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo

# Build image.
REGISTRY="registry.centreon.com"
LM_IMAGE="$REGISTRY/mon-lm-$VERSION-$RELEASE:$DISTRIB"
LM_WIP_IMAGE="$REGISTRY/mon-lm-19.10-wip:$DISTRIB"
