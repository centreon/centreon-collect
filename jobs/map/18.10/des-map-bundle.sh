...
SERVER_WIP_IMAGE="$REGISTRY/des-map-server-18.10-wip:$DISTRIB"
WEB_IMAGE="$REGISTRY/des-map-web-$VERSION-$RELEASE:$DISTRIB"
WEB_WIP_IMAGE="$REGISTRY/des-map-web-18.10-wip:$DISTRIB"
...
sed "s#@VERSION@#18.10#g;s#@DISTRIB@#el7#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo
