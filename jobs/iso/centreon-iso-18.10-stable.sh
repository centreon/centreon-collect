...
for distrib in el7 ; do
  ...
  SRCSIZE=`$SSH_REPO "stat -c '%s' /srv/iso/centreon-18.10-$RELEASE.$distrib.x86_64.iso"`  
  ...
  OUTPUT=`curl "https://download.centreon.com/api/?token=ML2OA4P43FDF456FG3EREYUIBAHT521&product=centreon&version=18.10-$RELEASE.$distrib.x86_64&extension=iso&md5=$SRCHASH&ddos=1&dryrun=1&release=18.10&size=$SRCSIZE"`
