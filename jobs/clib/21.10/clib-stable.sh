...
promote_rpms_from_testing_to_stable "standard" "$MAJOR" "el7" "x86_64" "clib" "$PROJECT-$VERSION-$RELEASE"
promote_rpms_from_testing_to_stable "standard" "$MAJOR" "el8" "x86_64" "clib" "$PROJECT-$VERSION-$RELEASE"
