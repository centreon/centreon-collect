...
# Publish RPMs.
put_internal_rpms "19.04" "el7" "x86_64" "clib" "$PROJECT-$VERSION-$RELEASE" output/x86_64/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "standard" "19.04" "el7" "x86_64" "clib" "$PROJECT-$VERSION-$RELEASE"
fi
