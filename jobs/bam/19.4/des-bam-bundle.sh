...
sed "s/@DISTRIB@/$DISTRIB/g" < bam/19.4/Dockerfile.in > bam/Dockerfile
sed "s#@PROJECT@#$PROJECT#g;s#@SUBDIR@#19.4/el7/noarch/bam/$PROJECT-$VERSION-$RELEASE#g" < repo/centreon-internal.repo.in > repo/centreon-internal.repo

# Build image.
REGISTRY="ci.int.centreon.com:5000"
BAM_IMAGE="$REGISTRY/des-bam-$VERSION-$RELEASE:$DISTRIB"
BAM_WIP_IMAGE="$REGISTRY/des-bam-19.4-wip:$DISTRIB"
