...
$SSH_REPO aws s3 cp --acl public-read "/srv/sources/bam/stable/$PROJECT-$VERSION-$RELEASE/$PROJECT-$VERSION-php71.tar.gz" "s3://centreon-download/enterprises/centreon-bam/centreon-bam-19.10/centreon-bam-$VERSION/$SRCHASH/$PROJECT-$VERSION-php$phpversion.tar.gz"

# Move RPMs to the stable repository.
promote_testing_rpms_to_stable "bam" "19.10" "el7" "noarch" "bam" "$PROJECT-$VERSION-$RELEASE"
