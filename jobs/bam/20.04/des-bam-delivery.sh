...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "bam" "20.04" "el7" "noarch" "bam" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "bam" "20.04" "el7" "noarch" "bam" "$PROJECT-$VERSION-$RELEASE"
  TARGETVERSION='20.04'
fi
