...
# Publish RPMs.
put_internal_rpms "21.04" "el8" "x86_64" "engine" "$PROJECT-$VERSION-$RELEASE" output/x86_64/*.rpm
if [ "$BUILD" '=' 'REFERENCE' ] ; then
  copy_internal_rpms_to_canary "standard" "21.04" "el8" "x86_64" "engine" "$PROJECT-$VERSION-$RELEASE"
fi
