...
if [ "$BUILD" '=' 'RELEASE' ] ; then
  ...
  copy_internal_rpms_to_testing "standard" "21.04" "el7" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE"
  copy_internal_rpms_to_testing "standard" "21.04" "el8" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE"
...
#
  ...
  promote_canary_rpms_to_unstable "standard" "21.04" "el7" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE"
  promote_canary_rpms_to_unstable "standard" "21.04" "el8" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE"
  TARGETVERSION='21.04'
fi
