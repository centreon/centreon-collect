...
put_internal_rpms "18.10" "$DISTRIB" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE" output/noarch/*.rpm
if [ "$BRANCH_NAME" '=' 'master' ] ; then
  copy_internal_rpms_to_canary "standard" "18.10" "el7" "noarch" "ppm" "$PROJECT-$VERSION-$RELEASE"
fi
