...
# Put sources online.
upload_tarball_for_download "centreon-collect" "$VERSION" "/srv/sources/standard/stable/centreon-collect-$VERSION-$RELEASE/centreon-collect-$VERSION.tar.gz" "s3://centreon-download/public/centreon-collect/centreon-collect-$VERSION.tar.gz"
