...
namespace                      com {
  namespace                    centreon {
	...
	private:
	  ...
	  char const*          _get_icmp_error_msg(unsigned char icmp_type, unsigned char icmp_code);
	  ...
	  int                  _recvfrom_wto(int sock,
					     ...
					     sockaddr* saddr,
					     unsigned int* timo);
	  int                  _wait_for_reply(int sock, unsigned int t);
	  ...
	  static const float   _pkt_backoff_factor = 1.5;
	  static const float   _target_backoff_factor = 1.5;
